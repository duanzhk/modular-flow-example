      ...
      _export("StringUtil", StringUtil = class StringUtil {
        ...
        static ellipsisString(str, maxChars) {
          ...
          if (str.length > maxChars) {
            var truncatedText = str.substring(0, maxChars);
        ...
        static substitute(str) {
          ...
          var parseByDic = rest.length == 1 && ObjectUtil.isObjectLiteral(rest[0]);
          ...
          if (parseByDic) {
            ...
            var match = str.matchAll(placeholderRegex);
            var i = 0;

            for (var element of match) {
            ...
            return str.replace(placeholderRegex, (match, key) => {
              var replacement = placeholders.get(match);
        ...
        static findAllSubstringsIndexes(mainStr, subStr) {
          var indexes = [];
          var currentIndex = mainStr.indexOf(subStr);
...
//# sourceMappingURL=2e9637caed7314ab874c76ef5141bc3da8213b4a.js.map